module Expedia
  ...
  class Api
    ...
    def get_list(args)
      ...
      services('/ean-services/rs/hotel/v3/list', args, method, { use_ssl: true, ignore_timeout: true } )
    end
    ...
    def get_availability(args)
      services('/ean-services/rs/hotel/v3/avail', args, :get, { use_ssl: true, ignore_timeout: true } )
    end
